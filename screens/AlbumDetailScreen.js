...
// import { ScrollView, StyleSheet, View, ActivityIndicator, Linking, Alert, FlatList } from 'react-native';
...
//     }
//   }
//   playSong = async (track, index) => {
//     if(this.currentSong && this.state.isPlaying) {
//       this.currentSong.stopAsync()
//     }
//     try {
//       const {sound: soundObject, status} = await Expo.Audio.Sound.create({uri: track.preview
//       }, {shouldPlay: true})
//     }catch(error){
...
//             leftIconOnLongPress={this.renderIcon(track, index)}
//             rightIcon={
//               <Icon
//                 raised
//                 name='star'
...
export default class AlbumDetailScreen extends React.Component {
  ...
  componentDidMount() {
    ...
    actions.searchAlbumTracks(album.id).then(
